...
const UPDATE_LOGS: LogEntry[] = [
  {
    version: 'v2.5',
    date: '2026-04-28',
    title: '🔐 Database Privat + Quick Restock + Smart Pricing + Happy Hour',
    changes: [
      ...
      { type: 'feat', text: '🎉 HAPPY HOUR — tombol baru di tab Rak yang langsung mengaktifkan boost 2× penjualan selama 60 detik. Cooldown 5 menit. Cocok dipakai di jam ramai untuk lonjakan profit instan.' },
